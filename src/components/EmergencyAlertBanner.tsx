...
export const EmergencyAlertBanner: React.FC<EmergencyAlertBannerProps> = ({
  ...
  return (
    <div className="fixed top-20 right-4 sm:right-6 z-50 max-w-md w-full space-y-3 font-sans pointer-events-none">
      <AnimatePresence mode="sync">
        ...
        {showNotificationPermPrompt && !activeAlert && (
          <motion.div
            ...
            className="pointer-events-auto bg-slate-900 border border-slate-700 text-white p-3.5 rounded-2xl shadow-2xl flex items-center justify-between text-xs backdrop-blur-md"
          >
        ...
        {/* Active High-Priority Critical Alert Banner with Framer Motion Slide-In */}
        {activeAlert && (
          <motion.div
            key={`stat-alert-${activeAlert.patientId || 'active'}`}
            ...
            className="pointer-events-auto bg-gradient-to-br from-rose-950 via-slate-950 to-red-950 border-2 border-rose-500 rounded-3xl p-4 shadow-[0_0_45px_rgba(244,63,94,0.5)] text-white relative overflow-hidden"
          >
            {/* Animated red beacon radar ring in corner */}
            <div className="absolute -top-6 -right-6 w-24 h-24 bg-rose-500/25 rounded-full blur-xl pointer-events-none"></div>
            ...
            <div className="flex items-center justify-between border-b border-rose-800/60 pb-2.5">
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="p-1 text-rose-300 hover:text-white rounded hover:bg-rose-900/50 cursor-pointer transition-colors"
                >
            ...
            <div className="py-3 space-y-2">
              <div className="flex items-start justify-between gap-2">
                ...
                <span className="bg-rose-600/40 text-rose-200 border border-rose-500 text-[10px] font-black px-2 py-0.5 rounded shrink-0">
